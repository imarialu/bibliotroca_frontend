            ...
            <MainLayout>
                ...
                <section className="w-[90%] md:ml-20 md:w-[720px] xl:w-[1100px]">
                    <div className="flex flex-col items-center p-10 mb-8 bg-white rounded-sm shadow-cont">
                        ...
                        <div className="w-[100%] mt-5 font-medium md:text-center md:text-lg md:w-[85%]">
                            <p className="mb-5">
                            ...
                            <div className="mt-5">
                                <h1 className="mb-5 text-2xl text-center font-outfit font-semibold text-purple md:text-3xl">Como funciona</h1>
